...
<?php if(isset($idC)){
  ...
  foreach ($idPs as $key => $value) {
    ...
    if ($parejasAEnfrentar[0]["fase"]>1 || $parejasAEnfrentar[7]["fase"]>1) {
      ...
      echo "<td>$pareja1</td><td></td>";
      echo "<td>$pareja8</td><td></td>";
    }
    echo "</tr>";
    echo "<tr>";
    if ($parejasAEnfrentar[1]["fase"]>1 || $parejasAEnfrentar[6]["fase"]>1) {
      ...
      echo "<td>$pareja2</td><td></td>";
      echo "<td>$pareja7</td><td></td>";
    }
    echo "</tr>";
    echo "<tr>";
    if ($parejasAEnfrentar[2]["fase"]>1 || $parejasAEnfrentar[5]["fase"]>1) {
      ...
      echo "<td>$pareja3</td><td></td>";
      echo "<td>$pareja6</td><td></td>";
    }
    echo "</tr>";
    echo "<tr>";
    if ($parejasAEnfrentar[3]["fase"]>1 || $parejasAEnfrentar[4]["fase"]>1) {
      ...
      echo "<td>$pareja4</td><td></td>";
      echo "<td>$pareja5</td><td></td>";
    }
    echo "</tr>";
    echo "</tbody>";
    echo "</table>";
    ...
    if($patata && $length == 2){
      ...
      if ($parejasG[0]["fase"]>3 || $parejasG[1]["fase"]>3) {
        ...
        echo "<td>$patata1</td><td></td>";
        echo "<td>$patata2</td><td></td>";
      }
